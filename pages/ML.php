...
<pre>
    ...
    En conséquence, l’ OKIMONO CORP.  décline toute responsabilité :
    ...
    L’ OKIMONO CORP. se réserve le droit de modifier ou de corriger le contenu de son site, incluant les présentes conditions, à tout moment sans préavis. Les internautes doivent donc consulter les dites conditions lors de chaque connexion.
...
<pre>
    ...
    Aucune licence, ni aucun droit autre que celui de consulter le site, n’est conféré au visiteur du site au regard des droits de propriété intellectuelle. Toute reproduction et toute utilisation de copie réalisée en dehors d’un usage strictement privé est expressément interdite.
    L’utilisation de la structure du site Internet et de ses éléments logiciels mettant notamment en œuvre tout ou partie des bases de données du dit site n’est autorisée que pour une utilisation strictement personnelle et privée excluant toute utilisation à des fins professionnelles et/ou commerciales.
    Signes distinctifs :
    Sauf mention contraire, les dénominations sociales, les logos, les produits et marques cités dans ce site Internet (produits ® et ™) sont la propriété de l’OKIMONO CORP. . Ils ne peuvent être utilisés sans l’autorisation écrite et préalable de l’OKIMONO CORP. .
    Base de données :
    Conformément aux dispositions de la loi n° 98-536 du 1er juillet 1998,portant transposition dans le Code de la propriété intellectuelle de la directive 96/9/CE du 11 mars 1996, concernant la protection juridique des bases de données, l’OKIMONO CORP.  est producteur et propriétaire de tout ou partie des bases de données composant le présent site.
    En accédant au présent site, l’utilisateur :
    –	reconnaît que les données le composant sont légalement protégées et ce, conformément aux dispositions de la loi du 1er juillet 1998précitée,
    –	s’interdit notamment d’extraire, réutiliser, stocker, reproduire, représenter ou conserver, directement ou indirectement, par transfert permanent ou temporaire, sur un support quelconque, par tout moyen et sous toute forme que ce soit, y compris par lien(s) hypertexte(s), toutou partie qualitativement ou quantitativement substantielle du contenu des bases de données figurant sur le site OKIMONO CORP.  ainsi que d’en faire l’extraction ou la réutilisation répétée et systématique de parties
     
    qualitativement et quantitativement non substantielles lorsque ces opérations excèdent manifestement les conditions d’utilisation normale.
    ...
    L’OKIMONO CORP.  conserve tous les droits patrimoniaux et moraux liés aux documents de ce site, sous réserve des droits dont bénéficient les auteurs d’œuvres publiées sur ce site. Ainsi, tous les droits de reproduction, sur supports électroniques ou papier, sont-ils réservés, y compris pour les documents téléchargeables et les représentations iconographiques et/ou photographiques.
...
<pre>
    ...
    La collecte, la conservation et l’utilisation des informations à caractère personnel que vous nous avez volontairement fournies nous sont utiles pour vous contacter, y compris par courrier électronique,
     
    et/ou pour répondre à vos commentaires ou demandes d’informations, et/ou pour traiter l’envoi de votre commande de produits ou de services offerts sur notre site Internet. En outre, la collecte des informations générales a pour but de vous fournir les produits et services les plus utiles et ciblés destinés à répondre à vos besoins et requêtes.
    Transmettons-nous les informations à des tiers ?
    L’OKIMONO CORP.  s’engage à ne pas échanger, vendre ou transmettre les données à caractère personnel vous concernant à d’autres entreprises que celles appartenant à son groupe, sauf dans les cas éventuellement requis par la loi ou pour l’éventuelle bonne exécution de la prestation à fournir. Vos données à caractère personnel seront de manière générale conservées dans les bases de données de l’OKIMONO CORP.  situé en France.
    Tout traitement éventuel de données répond aux principes de finalité, de proportionnalité et de sécurité encadrés par la loi du 6 janvier 1978.
    Que sont les cookies ?
    Les « cookies » sont des fichiers envoyés par un gestionnaire de site, en l’espèce de l’OKIMONO CORP.  sur le disque dur de l’internaute permettant au gestionnaire d’identifier et de mémoriser l’internaute lorsque celui-ci se connecte au site. L’OKIMONO CORP.  peut être amené à utiliser le système des »cookies » afin de collecter des informations lors de votre passage sur notre site. Cela nous permettra de savoir quelles sont les parties de notre site qui vous intéressent. L’OKIMONO CORP.  pourra alors mieux connaître vos centres d’intérêt et vous faire bénéficier des informations adaptées à vos besoins. Ces « cookies » vont vous éviter également de devoir fournir chaque fois des informations que vous nous avez déjà communiquées dans la mesure où ils se souviendront de votre passage sur notre site à une date antérieure.
    La plupart des navigateurs acceptent automatiquement les cookies, mais peuvent être configurés de manière à ne pas les accepter ou à provoquer un message d’avertissement en cas de cookies envoyé.
    Comment pouvez-vous modifier vos informations sur le site ? Conformément à l’article 27 de la loi 78- 17 Informatique et Liberté du 6janvier 1978, vous pouvez à tout moment vérifier, corriger, mettre à jour ou demander la suppression les informations personnelles vous concernant que vous nous auriez communiquées en nous écrivant à :
    Quelque part – Rue de Pas ici – 34000 MONTPELLIER                                     
